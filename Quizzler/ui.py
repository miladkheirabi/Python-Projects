...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score = Label(pady=20, text="Score:0", bg=THEME_COLOR, fg="white", font=("Arial", 16))
        self.score.grid(row=0, column=1)

        self.canvas = Canvas(width=300, height=250)
        self.canvas.grid(row=1, column=0, columnspan=2, padx=20, pady=20)
        self.question_text = self.canvas.create_text(150, 125, text="Test text!", font=FONT, width=280)
